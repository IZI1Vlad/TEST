...
public class CollateralObjectControllerTest {
    ...
    @Test
    public void saveCarAndGetInfo() throws Exception {
    ...
    private void assertCarDto(CarDto requestCar, CarDto responseCar) {
        ...
        List<Raiting> requestEstimates = requestCar.getRaitingListList();
        List<Raiting> responseEstimates = responseCar.getRaitingListList();
    ...
    @Test
    public void saveAirPlaneAndGetInfo() throws Exception {
        List<Raiting> raitingList = new ArrayList<>();
    ...
    private void assertAirplaneDto(AirPlaneDto requestCar, AirPlaneDto responseCar) {
        ...
        List<Raiting> requestEstimates = requestCar.getRaitingList();
        List<Raiting> responseEstimates = responseCar.getRaitingList();
        assertEquals(requestEstimates.size(), responseEstimates.size());
        for (int i = 0; i < requestEstimates.size(); i++) {
            assertEquals(requestEstimates.get(i).getValue(), responseEstimates.get(i).getValue());
            assertEquals(requestEstimates.get(i).getDate(), responseEstimates.get(i).getDate());
